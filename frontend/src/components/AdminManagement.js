...
function AdminManagement() {
 ...
 alert(' Records removed but automatic export failed. You can export manually using the Export button.');
 }
 ...
 <div style={{ fontSize: ".7rem", color: "#dc2626", marginBottom: ".5rem" }}> Reason must be at least 10 characters ({lateRemovalForm.reason.trim().length}/10)</div>
 )}
